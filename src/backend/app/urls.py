...
from .views.skill_views import SkillsView, SkillsTimelineView, SkillExpertiseUpdateView
...
urlpatterns = [
    ...
    path("skills/expertise/", SkillExpertiseUpdateView.as_view(), name="skills-expertise-update"),
