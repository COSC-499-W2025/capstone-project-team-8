...
# Add the repository root to sys.path so tests package can be imported
...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-rpamq73a+@!0ee+00f9+r@i)!$+sp(j2+_i#pd^(%lb)w2rc=-")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['testserver', 'localhost', '127.0.0.1', 'capstone_backend']
...
DATABASES = {
    "default": {
        ...
        "USER": config('DB_USER', default='capstone_user'),
        "PASSWORD": config('DB_PASSWORD', default='capstone_pass'),
...
REST_FRAMEWORK = {
    ...
    # Don't require authentication globally - let individual views decide
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://capstone_frontend:3000",
    "http://capstone_frontend",
]
